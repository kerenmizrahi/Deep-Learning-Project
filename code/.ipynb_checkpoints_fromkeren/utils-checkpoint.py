...
def plot_tsne(model, dataloader, dataset, device):
    '''
    ...
    if dataset == "MNIST":
        plt.savefig('MNIST/latent_tsne.png')
    else:
        plt.savefig('CIFAR10/latent_tsne.png')
    plt.close()
    ...
    if dataset == "MNIST":
        plt.savefig('MNIST/image_tsne.png')
    else:
        plt.savefig('CIFAR10/image_tsne.png')
