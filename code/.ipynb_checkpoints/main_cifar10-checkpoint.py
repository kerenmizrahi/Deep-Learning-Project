...
def cifar10_121(dl_train, dl_val, dl_test, device):
    ...
    trainer = autoencoder.autoencoderTrainer(encoder, decoder, dl_train, dl_test, loss_fn, optimizer, num_epochs, device)
...
def cifar10_122(dl_train, dl_val, dl_test, device):
    print("Initialize classifier + encoder...\n")
    encoder = autoencoders.Encoder_cifar10().to(device)
...
def cifar10_123(dl_train, dl_val, dl_test, device):
